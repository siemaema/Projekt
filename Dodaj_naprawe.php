...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    // Debug: Sprawdzanie pobranych danych
    // var_dump($existing_car_id, $new_car_registration_number, $client_id, $repair_description, $repair_cost, $start_date, $car_brand, $car_model, $car_year);
